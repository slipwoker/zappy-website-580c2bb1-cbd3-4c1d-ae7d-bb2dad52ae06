document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      // Validate non-required email and phone fields
      contactForm.querySelectorAll('input[type="email"]:not([required]), input[type="tel"]:not([required])').forEach(function(field) {
        const value = field.value.trim();
        if (value) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "היסטוריה לבגרות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var response = await fetch(apiBase + '/api/email/contact-form', {
                ...
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    websiteId: '580c2bb1-cbd3-4c1d-ae7d-bb2dad52ae06',
                    name: data.name || '',
                    email: data.email || '',
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '580c2bb1-cbd3-4c1d-ae7d-bb2dad52ae06';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '580c2bb1-cbd3-4c1d-ae7d-bb2dad52ae06';
